 ...
 */
public class HuiItemAdapterKotlin : BaseAdapter{
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        a.image.maxWidth = displayMetrics.widthPixels/2-4
        a.image.minimumWidth = displayMetrics.widthPixels/2-4
        a.image.maxHeight = displayMetrics.widthPixels/2-4
        a.image.minimumHeight = displayMetrics.widthPixels/2-4


        val imagesArray: Array<String>
//        imagesArray = ( data["thumb"] as String ).split(",")
