...
public class GetMethodActivity extends Activity {
    ...
    public void findViews() {
        setContentView(R.layout.activity_account_happy_bean_get_way2);
        String gid="";
...
//        tv_title.setText(title);
        ...
        webview.addJavascriptInterface(new GetMethodActivity.JavaScriptInterface(), "jsObj");
        webview.loadUrl("http://www.qkxmall.com/api/android/");
...
//                ToastUtils.showToast(context,"onKey keyCode:"+keyCode);
        ...
        image= (ImageView) findViewById(R.id.account_happy_bean_backup);
