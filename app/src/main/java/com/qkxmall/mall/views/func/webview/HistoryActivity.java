...
//        tv_title = (TextView) findViewById(R.id.tv_title);
        ...
        url="http://www.qkxmall.com/index.php?m=qkx&c=apipage&a=cloudcomm"+"&cid="+gid+"&tid="+6;
...
//        tv_title.setText(title);
        ...
        webview.addJavascriptInterface(new HistoryActivity.JavaScriptInterface(), "jsObj");
        webview.loadUrl(url);
