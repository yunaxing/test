...
public class CouCouGuiGeAdapter extends BaseAdapter {
    Context context;
//    List<Handler> childPoitionHandler = new ArrayList<>();
    ...
    public CouCouGuiGeAdapter(Context context,  List<HashMap<String,
...
//       addRadioButton(guigeList, a.mRadioGroup, position);
        CouCouGuiGeItemAdapter guiGeItemAdapter = new CouCouGuiGeItemAdapter(context,guigeList,
