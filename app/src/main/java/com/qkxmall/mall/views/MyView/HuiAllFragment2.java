...
/**
 * Created by Administrator on 2016/5/9. 代发货页面
 */
    ...
    public void loadmsg() {
        payOrderList.clear();
            {//待付款 √
                ...
                String url = API.HUI_ORDER_LIST+"&type=delivery"+"&uid="+lod.get("USER_INFO","UID","")+"&page="+i;
                Log.e("URL",url);
...
//                                PayOrderAdapter payOrderAdapter = new PayOrderAdapter(context, payOrderList);
    ...
    public class MyAdapter extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            Vh vh;
            if(convertView==null){
                convertView=View.inflate(context,R.layout.new_all_hui_order_listview_item_to_be_delivered,null);
                vh=new Vh();
...
//                    utils.display(vh.image, API.ADD + img);
                    Glide.with(HuiAllFragment2.this).load( API.ADD + img).into(vh.image);
