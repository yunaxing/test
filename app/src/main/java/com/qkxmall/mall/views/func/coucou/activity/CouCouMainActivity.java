...
import com.qkxmall.mall.views.fragment.newCloudMainFragment;
...
public class CouCouMainActivity extends Activity {
...
//    CloudHotAdapter hotAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_fragment_cloud_main);
        context = this;
        init();
        ...
        //即将揭晓
        LoadData2 willAnnounce = new LoadData2(progressDialog);
        String urlAnnounce = API.JJJX_THREE_URL+"&access_token="+(new Sha1().getDigestOfString((DateUtil.getCurrentDate()+"tga5yuontrnbuaebq906").getBytes()).toLowerCase());
...
//        String willOpenGridUrl = API.JJJX_THREE_URL+"&access_token="+(new Sha1().getDigestOfString((DateUtil.getCurrentDate()+"tga5yuontrnbuaebq906").getBytes()).toLowerCase());
...
//                    currentSort = "";
                    ...
                    String address = API.COUCOU_GET_ALL_LIST_URL+"&access_token="+(new Sha1().getDigestOfString((DateUtil.getCurrentDate()+"tga5yuontrnbuaebq906").getBytes()).toLowerCase());
...
//                    Log.e("currentSort",currentSort);
                ...
                //浜烘皵
                case R.id.sort_1: {
                    String address = API.COUCOU_GET_ALL_LIST_URL+ "&sort=curnum&order=desc"+"&access_token="
                            +(new Sha1().getDigestOfString((DateUtil.getCurrentDate()+"desc"+"curnum"+"tga5yuontrnbuaebq906").getBytes()).toLowerCase());
                    //currentAddress = currentAddress.replace(temp, currentSort);
                    ProgressDialog progressDialog = new ProgressDialog(context);
                    progressDialog.setMessage("数据加载中...");
                    progressDialog.show();
...
//                    Log.e("currentSort",currentSort);
                    ...
                    sort1.setTextColor(getResources().getColor(R.color.grid_view_background_grey_500));
                    sort2.setTextColor(getResources().getColor(R.color.white));
                    sort3.setTextColor(getResources().getColor(R.color.white));
                    sort4.setTextColor(getResources().getColor(R.color.white));
                    sort0.setBackgroundResource(R.color.grid_view_background_grey_500);
                    sort1.setBackgroundResource(R.color.white);
                    sort2.setBackgroundResource(R.color.grid_view_background_grey_500);
                    sort3.setBackgroundResource(R.color.grid_view_background_grey_500);
                    sort4.setBackgroundResource(R.color.grid_view_background_grey_500);
                }
                break;
                //浠锋牸
                case R.id.sort_2: {
                    String address = API.COUCOU_GET_ALL_LIST_URL+ "&sort=postdate&order=desc"+"&access_token="+(new Sha1().getDigestOfString((DateUtil.getCurrentDate()+"desc"+"postdate"+"tga5yuontrnbuaebq906").getBytes()).toLowerCase());
                    //currentAddress = currentAddress.replace(temp, currentSort);
                    ProgressDialog progressDialog = new ProgressDialog(context);
                    progressDialog.setMessage("数据加载中...");
                    progressDialog.show();
...
//                    Log.e("currentSort",currentSort);
                    sort0.setTextColor(getResources().getColor(R.color.white));
                    sort1.setTextColor(getResources().getColor(R.color.white));
                    sort2.setTextColor(getResources().getColor(R.color.grid_view_background_grey_500));
                    sort3.setTextColor(getResources().getColor(R.color.white));
                    sort4.setTextColor(getResources().getColor(R.color.white));
                    sort0.setBackgroundResource(R.color.grid_view_background_grey_500);
                    sort1.setBackgroundResource(R.color.grid_view_background_grey_500);
                ...
                //鏈€鏂?
                case R.id.sort_3: {
                    String address = API.COUCOU_GET_ALL_LIST_URL+ "&sort=totalprice&order=desc"+"&access_token="+(new Sha1().getDigestOfString((DateUtil.getCurrentDate()+"desc"+"totalprice"+"tga5yuontrnbuaebq906").getBytes()).toLowerCase());
                    //currentAddress = currentAddress.replace(temp, currentSort);
                    ProgressDialog progressDialog = new ProgressDialog(context);
                    progressDialog.setMessage("数据加载中...");
                    progressDialog.show();
...
//                    Log.e("currentSort",currentSort);
                    ...
                    sort1.setTextColor(getResources().getColor(R.color.white));
                    sort2.setTextColor(getResources().getColor(R.color.white));
                    sort3.setTextColor(getResources().getColor(R.color.grid_view_background_grey_500));
                    sort4.setTextColor(getResources().getColor(R.color.white));
                    sort0.setBackgroundResource(R.color.grid_view_background_grey_500);
                    sort1.setBackgroundResource(R.color.grid_view_background_grey_500);
                    sort2.setBackgroundResource(R.color.grid_view_background_grey_500);
...
//                    Log.e("currentSort",currentSort);
                    ...
                    sort2.setTextColor(getResources().getColor(R.color.white));
                    sort3.setTextColor(getResources().getColor(R.color.white));
                    sort4.setTextColor(getResources().getColor(R.color.grid_view_background_grey_500));
                    sort0.setBackgroundResource(R.color.grid_view_background_grey_500);
                    sort1.setBackgroundResource(R.color.grid_view_background_grey_500);
                    sort2.setBackgroundResource(R.color.grid_view_background_grey_500);
                    sort3.setBackgroundResource(R.color.grid_view_background_grey_500);
    ...
    private void init() {
        cloudBuyMenu = (ImageView) findViewById(R.id.cloud_buy_title_menu);
        advertisement = (ViewPager) findViewById(R.id.ads);
        open = (LinearLayout) findViewById(R.id.open);

        cloudSearch = (ImageView) findViewById(R.id.cloud_search);
        messageCloud = (ImageView) findViewById(R.id.message);
        willOpen = (ImageView) findViewById(R.id.will_open);
        ...
        willOPenGrid = (GridView)findViewById(R.id.willOpen);
...
//        hot.setFocusable(false);
        pullScroll = (PullToRefreshScrollView) findViewById(R.id.cloud_buy_scroll);
        ...
        sort0.setTextColor(getResources().getColor(R.color.grid_view_background_grey_500));
        sort1.setTextColor(getResources().getColor(R.color.grid_view_background_grey_500));
        sort2.setTextColor(getResources().getColor(R.color.white));
        sort3.setTextColor(getResources().getColor(R.color.white));
        sort4.setTextColor(getResources().getColor(R.color.white));
...
//        String address = API.JJJX_THREE_URL+"&access_token="+(new Sha1().getDigestOfString((DateUtil.getCurrentDate()+"tga5yuontrnbuaebq906").getBytes()).toLowerCase());
        String address = API.COUCOU_GET_ALL_LIST_URL+ "&sort=curnum&order=desc"+"&access_token="+(new Sha1().getDigestOfString((DateUtil.getCurrentDate()+"desc"+"curnum"+"tga5yuontrnbuaebq906").getBytes()).toLowerCase());
...
//                                grid.setOnItemClickListener(new OnItemClickListeners());
    ...
    private class LoadData2 extends Handler {
        ProgressDialog progressDialog;

        public LoadData2(ProgressDialog progressDialog) {
            this.progressDialog = progressDialog;
        }
...
//                                    map.put("cid", object.get("cid"));
                                    ...
                                    if(i == 0){
//                                        periods.setText(object.getString("term"));
                                        name.setText(object.getString("goods_name"));
                                        price.setText(object.getString("totalprice"));
                                        image.setImageURI(Uri.parse(API.ADD + object.getString("img")));
                                        total.setText(object.getString("totalnum"));
                                        current.setText(object.getString("curnum"));
//                                        remain.setText(object.getString("remain"));
                                        progress.setMax(Integer.parseInt(object.getString("totalnum")));
                                        progress.setProgress(Integer.parseInt(object.getString("curnum")));
                                    }else if(i<4){
                                        map.put("name", object.get("goods_name"));
                                        if (object.has("commnum"))
                                            map.put("commnum", object.get("commnum"));
                                ...
                                System.out.println("!!!!!!!!!!!!!!!!! 数据源长度2：" + dataList.size());
                                cloudHotAdapter = new CloudHotAdapter(context,dataList);
                                willOPenGrid.setAdapter(cloudHotAdapter);
//                                cloudHotAdapter.notifyDataSetChanged();
//                                grid.setOnItemClickListener(new OnItemClickListeners());
                            }else {
                                Toast.makeText(context, "获取失败", Toast.LENGTH_SHORT).show();
    ...
    public void showShare() {
        ...
        // 设置分享图片, 参数2为图片的url地址
        mController.setShareMedia(new UMImage(this, "http://www.qkxmall.com/xiazai/"));
                ...
                case BackgroundTask.SUCCESS: {
                    ...
                    if (bundle != null) {
                        try {
                            ...
                            periods.setText(data.getString("term"));
                            name.setText(data.getString("goods_name"));
                            price.setText(data.getString("totalprice"));
                ...
                case BackgroundTask.SUCCESS: {
                    ...
                    if (bundle != null) {
                        try {
                            ...
                            Object m = dataArray.get(0);
                            for (int i = 0; i < dataArray.length(); i++) {
                                JSONObject object = dataArray.getJSONObject(i);
                                HashMap<String, Object> data = new HashMap<>();
                                data.put("cid","cid");
                                data.put("name", object.getString("goods_name"));
                                data.put("c_totalprice", object.getString("totalprice"));
                                data.put("c_totalterm", "totalterm");
                                data.put("goodsname", object.getString("goods_name"));
                                data.put("goods_id", object.getString("goods_id"));
                                data.put("totalnum", object.getString("totalnum"));
                                data.put("curnum", object.getString("curnum"));
                                data.put("remain", "remain");
                                data.put("img", object.getString("img"));
                    ...
                    if (bundle != null) {
                        try {
                            ...
                            for (int i = 0; i < dataArray.length(); i++) {
                                ...
                                data.put("c_totalterm", jsonObject.get("totalterm"));
