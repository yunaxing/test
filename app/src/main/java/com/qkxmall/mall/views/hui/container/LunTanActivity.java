...
/**
 * Created by xingyuna on 2017/5/7.
 */
...
//    ImageView image;//返回按钮
    ...
    public void findViews() {
        setContentView(R.layout.activity_luntan_webview);
        String gid="";
...
//        tv_title.setText(title);
        ...
        webview.addJavascriptInterface(new LunTanActivity.JavaScriptInterface(), "jsObj");
        webview.loadUrl(url);
