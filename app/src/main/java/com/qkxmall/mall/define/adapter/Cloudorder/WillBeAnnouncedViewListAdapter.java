 ...
 */
public class WillBeAnnouncedViewListAdapter extends BaseAdapter {
    Context context;
    List<HashMap<String , Object>> list;

    public WillBeAnnouncedViewListAdapter(Context context, List<HashMap<String, Object>> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView != null){
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.all_cloud_order_all_order_list_layout_will_be_announced,null);
